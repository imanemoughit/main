...
print("loading model")
model = AutoModelForCausalLM.from_pretrained(model_name, cache_dir='/HDD18TB/wannita/LLM_HF', **kwargs)
print("loading tokenizer")
tokenizer = AutoTokenizer.from_pretrained(model_name,  cache_dir='/HDD18TB/wannita/LLM_HF')
...
def text_to_testcase(max_to_generate=128, temperature=0.2):
    example = '''\
import sys
import io
