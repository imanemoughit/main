...
input_dir = '/home/wannita/HDD18TB/active_repo/pyRL/text-to-testcase/dataset/APPS_new/apps_test_5000.csv'
input_column = 'prompt_testcase_llm'
output_filename = 'save/starcoder_apps_testcase_beam'
batch_size = 1
...
device = "cuda"
tokenizer = AutoTokenizer.from_pretrained(checkpoint, use_auth_token=access_token, cache_dir='/HDD18TB/wannita/LLM_HF')
...
model = AutoModelForCausalLM.from_pretrained(checkpoint,
                                             ...
                                             cache_dir='/HDD18TB/wannita/LLM_HF') 
