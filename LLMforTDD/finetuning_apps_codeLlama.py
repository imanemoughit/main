...
# Initialize the CodeLlama model and tokenizer
checkpoint = "codellama/CodeLlama-small"
...
output_dir = 'save/APPS/codellama/CodeLlama-small'
...
trainer = Trainer(
    ...
    data_collator=DataCollatorForSeq2Seq(tokenizer) if 'CodeLlama' in model_name else DataCollatorForLanguageModeling(tokenizer, mlm=False),
    tokenizer=tokenizer,
)
